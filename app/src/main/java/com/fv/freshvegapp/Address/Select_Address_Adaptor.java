...
public class Select_Address_Adaptor extends RecyclerView.Adapter<Select_Address_Adaptor.ViewHolder> {

private Context context;
private List<AddressPojo> uploads;

public Select_Address_Adaptor(Context context, List<AddressPojo> uploads) {
...
public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        .inflate(R.layout.select_address_desgin, parent, false);
...
public void onBindViewHolder(final ViewHolder holder, final int position) {
    ...
    holder.select_address.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            SharedPreferences preferences = context.getSharedPreferences("cart_select", Context.MODE_PRIVATE);
                ...
                String add = "1";
                edito.putString("selectedcart",add);
                edito.apply();
    ...
    holder.edit.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            SharedPreferences preferences = context.getSharedPreferences("back3", Context.MODE_PRIVATE);
            SharedPreferences.Editor edito = preferences.edit();
            String add = "1";
            edito.putString("back3",add);
            edito.apply();
